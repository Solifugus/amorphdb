# AmorphDB Development Plan — completed steps

Historical record. **Nothing here is outstanding work** — the active plan is
`DEVPLAN.md` at the repository root.

Kept because these entries record *why* things were built the way they were, and
several carry findings that still matter (the storage defect behind Step 19a, the
protocol stubs behind Step 30). Split out of the root plan on 2026-07-30, when it
had grown past 1,800 lines and mixed four months of finished work in with the
next thing to do.

> **Note on phase numbering.** Steps 1–16 below belong to an earlier numbering
> where "Phase 6" meant *Cleanup and Documentation*. The live plan reuses Phase 6
> for *Date and Time*. Both numberings appear in commit history; the distinction
...
|---|---|---|
| 1 | Replace `embed()` with `asset()` constructor | 2026-04-02 |
| 2 | Record literal assignment | 2026-04-02 |
| 3 | Recursive assignment | 2026-04-02 |
| 4 | Same-line definitions | 2026-04-02 |
| 5 | Projection syntax | 2026-04-02 |
| 6 | Embed keyword in record bodies | 2026-04-02 |
| 7 | REPL auto-inferred display and hints | 2026-04-02 |
| 8 | XML import and export | 2026-04-02 |
| 9 | ARI fixed-width file import | 2026-04-02 |
| 10 | Path directory data structure | 2026-04-02 |
| 11 | Subscription registry data structure | 2026-04-02 |
| 12 | Write authority assignment and promotion | 2026-04-02 |
| 13 | Subscription-based replication | 2026-04-02 |
| 14 | Cutover: enable subscription model | 2026-04-02 |
| 15 | Update status messages and CLI output | 2026-04-02 |
| 16 | Archive old specs, verify current specs | 2026-04-02 |
| 17 | Extended text literal syntax `_"…"_` | 2026-07-29 |
| 18 | Interpolating text literal `~"…{path}…"~` | 2026-07-29 |
| 19 | Time literals produce a real `types.Time` | 2026-07-29 |
| 19a | Storage truncated the time precision byte | 2026-07-29 |
| 25 | As-of temporal queries `path[@time]` | 2026-07-29 |
| 28 | `(quietly)`: lost write and suppression | 2026-07-29 |
| 30 | READ_AT over the wire | 2026-07-30 |
